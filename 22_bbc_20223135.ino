...
// Servo adjustment
#define _DUTY_MAX 1890  // Servo angle: D degree
#define _DUTY_NEU 1500  // Servo angle: 0 degree
#define _DUTY_MIN 1110   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 790 // Replace with |D - E| degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 730 + (-2.51*a_value) + (-1.2E-04*a_value*a_value) + (9.72E-06*a_value*a_value*a_value) + (-9.68E-09*a_value*a_value*a_value*a_value);
}
